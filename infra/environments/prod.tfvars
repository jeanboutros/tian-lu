# environments/prod.tfvars — the PROD environment (= one Floci account = one 12-digit AKID).
...
environment = "prod"
account_id  = "444444444444" # prod AKID (dev=111111111111, test=222222222222, uat=333333333333)
