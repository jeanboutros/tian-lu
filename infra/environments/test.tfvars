# environments/test.tfvars — the TEST environment (= one Floci account = one 12-digit AKID).
...
environment = "test"
account_id  = "222222222222" # test AKID (dev=111111111111, uat=333333333333, prod=444444444444)
